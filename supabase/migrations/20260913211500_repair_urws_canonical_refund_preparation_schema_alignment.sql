...
begin
 ...
 insert into public.refunds(payment_id,invoice_id,amount,reason,status) values(p.id,p.invoice_id,rr.amount,coalesce(rr.reason,'Approved membership refund'),'pending') returning id into v_refund;

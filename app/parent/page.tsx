...
import ParentFamilyOS from '@/components/hubs/parent/ParentFamilyOS';
...
export default function ParentPage(){return <Suspense fallback={<Loading/>}><ParentFamilyOS/></Suspense>}

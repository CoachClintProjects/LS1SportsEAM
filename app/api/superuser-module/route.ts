...
const domains: Record<string, Domain> = {
  ...
  programs: { label: 'Programs', tables: [{table:'programs',label:'Programs'},{table:'teams',label:'Teams'},{table:'seasons',label:'Seasons'}] },
  teams: { label: 'Teams', tables: [{table:'teams',label:'Teams'},{table:'team_memberships',label:'Roster Assignments'},{table:'programs',label:'Programs'},{table:'seasons',label:'Seasons'}] },
  seasons: { label: 'Seasons', tables: [{table:'seasons',label:'Seasons'},{table:'teams',label:'Teams'},{table:'programs',label:'Programs'}] },
  ...
  'eligibility-rules': { label: 'Eligibility Rules', tables: [{table:'eligibility_rules',label:'Eligibility Rules'}] },

...
const domains: Record<string, Domain> = {
  ...
  competition: { label: 'Competition Engine', tables: [{table:'competitions',label:'Competitions'},{table:'competition_sessions',label:'Sessions'},{table:'competition_events',label:'Events'},{table:'competition_entries',label:'Entries'},{table:'competition_results',label:'Results'},{table:'competition_official_assignments',label:'Officials'},{table:'competition_rulesets',label:'Rulesets'},{table:'competition_reconciliations',label:'Reconciliations'},{table:'competition_publications',label:'Publications'},{table:'competition_import_files',label:'Import Files'}] },
  'competition-events': { label: 'Competition Events & Sessions', tables: [{table:'competition_sessions',label:'Sessions'},{table:'competition_events',label:'Events'},{table:'competition_rounds',label:'Rounds'},{table:'competition_formats',label:'Formats'},{table:'competition_deadlines',label:'Deadlines'}] },
  'competition-entries': { label: 'Competition Entries', tables: [{table:'competition_entry_batches',label:'Entry Batches'},{table:'competition_entries',label:'Entries'},{table:'competition_entry_fees',label:'Entry Fees'},{table:'competition_scratches',label:'Scratches'},{table:'competition_checkins',label:'Check-ins'}] },
  'competition-results': { label: 'Competition Results', tables: [{table:'competition_results',label:'Results'},{table:'competition_result_versions',label:'Result Versions'},{table:'competition_result_sources',label:'Result Sources'},{table:'competition_score_snapshots',label:'Score Snapshots'}] },
  'competition-officials': { label: 'Officials & Judicial', tables: [{table:'competition_official_assignments',label:'Official Assignments'},{table:'competition_official_requirements',label:'Official Requirements'},{table:'competition_judicial_cases',label:'Judicial Cases'}] },
  'competition-seeding': { label: 'Seeding & Advancement', tables: [{table:'competition_seeding_runs',label:'Seeding Runs'},{table:'competition_seeding_assignments',label:'Seeding Assignments'},{table:'competition_advancement_decisions',label:'Advancement Decisions'}] },
  'competition-timing': { label: 'Timing Systems', tables: [{table:'competition_timing_sessions',label:'Timing Sessions'},{table:'competition_timing_messages',label:'Timing Messages'},{table:'competition_source_artifacts',label:'Source Artifacts'}] },
  'competition-rules': { label: 'Competition Rules & Eligibility', tables: [{table:'competition_rulesets',label:'Rulesets'},{table:'competition_scoring_rules',label:'Scoring Rules'},{table:'competition_rule_evaluations',label:'Rule Evaluations'},{table:'competition_eligibility_decisions',label:'Eligibility Decisions'}] },
  'competition-reconciliation': { label: 'Competition Reconciliation', tables: [{table:'competition_reconciliations',label:'Reconciliations'},{table:'competition_reconciliation_items',label:'Reconciliation Items'},{table:'competition_exceptions',label:'Exceptions'}] },
  'competition-publication': { label: 'Competition Publication & Reports', tables: [{table:'competition_publications',label:'Publications'},{table:'competition_report_definitions',label:'Report Definitions'},{table:'competition_report_runs',label:'Report Runs'}] },
  'competition-records': { label: 'Records & Awards', tables: [{table:'competition_record_books',label:'Record Books'},{table:'competition_records',label:'Records'},{table:'competition_record_claims',label:'Record Claims'},{table:'competition_award_programs',label:'Award Programs'},{table:'competition_awards',label:'Awards'}] },
  'competition-imports': { label: 'Competition Imports', tables: [{table:'competition_import_files',label:'Import Files'},{table:'competition_import_records',label:'Import Records'},{table:'competition_import_profiles',label:'Import Profiles'},{table:'competition_source_systems',label:'Source Systems'}] },
  ...
  rules: { label: 'Rules Engine', tables: [{table:'rules',label:'Rules'},{table:'business_rule_definitions',label:'Business Rule Definitions'},{table:'rule_parameters',label:'Rule Parameters'},{table:'eligibility_rules',label:'Eligibility Rules'},{table:'validation_rule_definitions',label:'Validation Rules'},{table:'data_quality_rules',label:'Data Quality Rules'}] },
  'business-rules': { label: 'Business Rules', tables: [{table:'business_rule_definitions',label:'Business Rule Definitions'},{table:'rule_parameters',label:'Rule Parameters'},{table:'rules',label:'Rules'}] },
  'eligibility-rules': { label: 'Eligibility Rules', tables: [{table:'eligibility_rules',label:'Eligibility Rules'},{table:'competition_eligibility_decisions',label:'Eligibility Decisions'}] },
  'validation-rules': { label: 'Validation Rules', tables: [{table:'validation_rule_definitions',label:'Validation Rule Definitions'},{table:'data_quality_rules',label:'Data Quality Rules'}] },
  'data-quality-rules': { label: 'Data Quality Rules', tables: [{table:'data_quality_rules',label:'Data Quality Rules'},{table:'data_quality_issues',label:'Data Quality Issues'}] },

  integrations: { label: 'Integrations', tables: [{table:'integration_connections',label:'Connections'},{table:'integration_definitions',label:'Definitions'},{table:'integration_runs',label:'Runs'},{table:'integration_event_log',label:'Events'},{table:'integration_dead_letters',label:'Dead Letters'},{table:'integration_mappings',label:'Mappings'}] },
  'integration-connections': { label: 'Integration Connections', tables: [{table:'integration_connections',label:'Connections'},{table:'integration_definitions',label:'Definitions'}] },
  'integration-mappings': { label: 'Integration Mappings', tables: [{table:'integration_mappings',label:'Mappings'},{table:'integration_definitions',label:'Definitions'}] },
  'integration-runs': { label: 'Integration Runs', tables: [{table:'integration_runs',label:'Runs'},{table:'integration_event_log',label:'Events'}] },
  'integration-dead-letters': { label: 'Integration Dead Letters', tables: [{table:'integration_dead_letters',label:'Dead Letters'},{table:'integration_runs',label:'Runs'},{table:'integration_event_log',label:'Events'}] },
